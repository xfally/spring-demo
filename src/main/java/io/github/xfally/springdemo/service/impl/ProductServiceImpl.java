...
import io.github.xfally.springdemo.dao.ds1.repository.ProductRepository;
...
public class ProductServiceImpl implements IProductService {
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'product_' + #id")
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'product_list'")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'product_list'", beforeInvocation = false)
        }
    )
    @CachePut(value = "springdemo", key = "'product_' + #result.id", condition = "#result.id != 'null'")
    ...
    @CachePut(value = "springdemo", key = "'product_' + #result.id")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'product_' + #id", beforeInvocation = false),
            @CacheEvict(value = "springdemo", key = "'product_list'", beforeInvocation = false)
        }
    )
