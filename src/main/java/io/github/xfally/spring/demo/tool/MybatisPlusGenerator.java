package io.github.xfally.spring.demo.tool;
...
public class MybatisPlusGenerator {
    ...
    private static void generate(String DS_URL, String DS_DRIVER_NAME, String DS_USER_NAME, String DS_PASSWORD, String PKG_PARENT, String[] TABLE_LIST, String MAPPER_PART) {
        ...
        */
        ...
        // 模块名，比如公共包路径是`io.github.xfally.spring.demo`，如果模块名是`xxx`，则会在`io.github.xfally.spring.demo.xxx`下生成controller和service等包
    ...
    public static void main(String[] args) {
        String DS_URL = "jdbc:mysql://localhost:3306/spring_demo?useUnicode=true&useSSL=false&character_set_server=utf8mb4";
        String DS_DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
        String DS_USER_NAME = "root";
        String DS_PASSWORD = "123456";
        String PKG_PARENT = "io.github.xfally.spring.demo";
        ...
        String DS_URL_2 = "jdbc:postgresql://localhost:5432/spring_demo";
        String DS_DRIVER_NAME_2 = "org.postgresql.Driver";
        String DS_USER_NAME_2 = "postgres";
        String DS_PASSWORD_2 = "123456";
        String PKG_PARENT_2 = "io.github.xfally.spring.demo";
