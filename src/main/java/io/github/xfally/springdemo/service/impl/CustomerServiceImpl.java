...
import io.github.xfally.springdemo.dao.ds1.repository.CustomerRepository;
...
public class CustomerServiceImpl implements ICustomerService {
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'customer_' + #id")
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'customer_list'")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'customer_list'", beforeInvocation = false)
        }
    )
    @CachePut(value = "springdemo", key = "'customer_' + #result.id", condition = "#result.id != 'null'")
    ...
    @CachePut(value = "springdemo", key = "'customer_' + #result.id")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'customer_' + #id", beforeInvocation = false),
            @CacheEvict(value = "springdemo", key = "'customer_list'", beforeInvocation = false)
        }
    )
