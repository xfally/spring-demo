...
public class Ds2JpaConfig {
    static final String REPOSITORY_PACKAGE = "io.github.xfally.springdemo.dao.ds2.repository";
    private static final String ENTITY_PACKAGE = "io.github.xfally.springdemo.dao.ds2.entity";
