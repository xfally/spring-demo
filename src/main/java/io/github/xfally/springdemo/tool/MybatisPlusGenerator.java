package io.github.xfally.springdemo.tool;
...
public class MybatisPlusGenerator {
    ...
    private static void generate(String DS_URL, String DS_DRIVER_NAME, String DS_USER_NAME, String DS_PASSWORD, String PKG_PARENT, String[] TABLE_LIST, String MAPPER_PART) {
        ...
        */
        ...
        // 模块名，比如公共包路径是`io.github.xfally.springdemo`，如果模块名是`xxx`，则会在`io.github.xfally.springdemo.xxx`下生成controller和service等包
    ...
    public static void main(String[] args) {
        ...
        String PKG_PARENT = "io.github.xfally.springdemo";
        ...
        String PKG_PARENT_2 = "io.github.xfally.springdemo";
