...
public class Ds1JpaConfig {
    static final String REPOSITORY_PACKAGE = "io.github.xfally.spring.demo.dao.ds1.repository";
    private static final String ENTITY_PACKAGE = "io.github.xfally.spring.demo.dao.ds1.entity";
