...
import io.github.xfally.springdemo.dao.ds1.repository.OrderRepository;
...
public class OrderServiceImpl implements IOrderService {
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'order_' + #id")
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'order_list'")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'order_list'", beforeInvocation = false)
        }
    )
    @CachePut(value = "springdemo", key = "'order_' + #result.id", condition = "#result.id != 'null'")
    ...
    @CachePut(value = "springdemo", key = "'order_' + #result.id")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'order_' + #id", beforeInvocation = false),
            @CacheEvict(value = "springdemo", key = "'order_list'", beforeInvocation = false)
        }
    )
