...
import io.github.xfally.springdemo.dao.ds0.repository.LogRepository;
...
public class LogServiceImpl implements ILogService {
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'log_' + #id")
    ...
    @Override
    @Cacheable(value = "springdemo", condition = "#result != 'null'", key = "'log_list'")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'log_list'", beforeInvocation = false)
        }
    )
    @CachePut(value = "springdemo", key = "'log_' + #result.id", condition = "#result.id != 'null'")
    ...
    @CachePut(value = "springdemo", key = "'log_' + #result.id")
    ...
    @Caching(
        evict = {
            @CacheEvict(value = "springdemo", key = "'log_' + #id", beforeInvocation = false),
            @CacheEvict(value = "springdemo", key = "'log_list'", beforeInvocation = false)
        }
    )
