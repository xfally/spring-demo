...
import io.github.xfally.springdemo.config.datasource.DataSourceContextHolder;
import io.github.xfally.springdemo.config.datasource.DataSourceEnum;
...
public class DataSourceSwitchAspect {
    ...
    @Pointcut("execution(* io.github.xfally.springdemo.dao.ds1.mapper..*.*(..))")
    private void ds1Aspect() {
    }

    @Pointcut("execution(* io.github.xfally.springdemo.dao.ds2.mapper..*.*(..))")
